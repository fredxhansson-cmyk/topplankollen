  ...
  return (
    <>
      ...
      <main style={{ maxWidth:760, margin:'0 auto', padding:'56px 20px', lineHeight:1.8, color:'#374151', fontFamily:'Inter,sans-serif' }}>
        ...
        <p style={{ marginBottom:20, fontSize:15 }}>Topplånkollen är en SEO-driven jämförelsesajt som samlar och presenterar information om leverantörer inom finans. Vi rangordnar och betygsätter baserat på pris, villkor, kundservice och användarrecensioner. Vår trafikkälla är organisk söktrafik via Google och Bing.</p>
